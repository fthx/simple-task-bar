...
const WindowList = new Lang.Class({
    ...
    _updateMenu: function() {
        ...
        for ( let workspace_index=0; workspace_index<this.workspaces_count; ++workspace_index ) {
            ...
            if(this.sticky_windows.length && (workspace_index==0)) {
                for ( let i = 0; i < this.sticky_windows.length; ++i ) {
                	...
                	this.box.icon = this.app.create_icon_texture(22);
                	if (metaWindow.is_hidden()) {this.box.icon.set_opacity(127); this.box.style_class = 'hidden-app';}
                	else {
